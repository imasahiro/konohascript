...
static knh_data_t ClassData0[] = {
	...
	DATA_CLASS0, CLASS_Iterator, _DATA("konoha.Iterator"), CFLAG_Iterator, CLASS_Iterator, CLASS_Object, 1 + 0 /*2*/,
...
static knh_data_t ParamArrayData0[] = {
	...
	DATA_PARAM/*45*/, 0, 3, 1, TYPE_Int, FN_init, TYPE_String, FN_path, TYPE_NameSpace, FN_ns, TYPE_This, FN_return,
	DATA_PARAM/*46*/, 0, 2, 1, TYPE_String, FN_event, TYPE_String, FN_msg, TYPE_Exception, FN_return,
	DATA_PARAM/*47*/, 0, 2, 1, TYPE_dynamic, FN_base, TYPE_Method, FN_method, TYPE_This, FN_return,
	DATA_PARAM/*48*/, 0, 1, 1, TYPE_String, FN_msg, TYPE_Assurance, FN_return,
	DATA_PARAM/*49*/, 0, 1, 1, TYPE_Class, FN_c, TYPE_Boolean, FN_return,
	DATA_PARAM/*50*/, 0, 1, 1, TYPE_dynamic, FN_value, TYPE_Boolean, FN_return,
	...
	DATA_PARAM/*54*/, 0, 1, 1, TYPE_dynamic, FN_v, TYPE_Boolean, FN_return,
	...
	DATA_PARAM/*67*/, 0, 2, 1, TYPE_String, FN_urn, TYPE_NameSpace, FN_ns, TYPE_This, FN_return,
	...
	DATA_PARAM/*74*/, 0, 3, 1, TYPE_String, FN_urn, TYPE_String, FN_mode, TYPE_NameSpace, FN_, TYPE_InputStream, FN_return,
	DATA_PARAM/*75*/, 0, 1, 1, TYPE_StringDecoder, FN_c, TYPE_StringDecoder, FN_return,
	DATA_PARAM/*76*/, 0, 3, 1, TYPE_String, FN_urn, TYPE_String, FN_mode, TYPE_NameSpace, FN_, TYPE_OutputStream, FN_return,
...
static knh_data_t APIData0[] = {
	...
	DATA_METHOD0, CLASS_Assurance, MN_new, FLAG_Method_Const, _DATA(Assurance_new), /*P=*/48,
	...
	DATA_METHOD0, CLASS_InputStream, MN_new, FLAG_Method_Throwable, _DATA(InputStream_new), /*P=*/74,
	...
	DATA_METHOD0, CLASS_InputStream, MN_readLine, FLAG_Method_Iterative, _DATA(InputStream_readLine), /*P=*/23,
	DATA_METHOD0, CLASS_OutputStream, MN_new, FLAG_Method_Throwable, _DATA(OutputStream_new), /*P=*/76,
	...
	DATA_METHOD0, CLASS_Regex, MN_opHAS, FLAG_Method_Const, _DATA(Regex_opHAS), /*P=*/53,
