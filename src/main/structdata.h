...
static knh_data_t ParamArrayData0[] = {
	...
	DATA_PARAM/*29*/, 0, 1, 1, TYPE_dynamic, FN_x, TYPE_dynamic, FN_return,
	DATA_PARAM/*30*/, 0, 1, 1, TYPE_T1, FN_key, TYPE_Boolean, FN_return,
	DATA_PARAM/*31*/, 0, 1, 1, TYPE_T1, FN_key, TYPE_T2, FN_return,
	DATA_PARAM/*32*/, 0, 2, 0, TYPE_T1, FN_key, TYPE_T2, FN_value,
	DATA_PARAM/*33*/, 0, 1, 0, TYPE_T1, FN_key,
	DATA_PARAM/*34*/, 0, 0, 1, TYPE_T1ARRAY, FN_return,
	DATA_PARAM/*35*/, 0, 1, 0, TYPE_Int, FN_seed,
	DATA_PARAM/*36*/, 0, 1, 1, TYPE_Int, FN_n, TYPE_Int, FN_return,
	DATA_PARAM/*37*/, 0, 0, 1, TYPE_Float, FN_return,
	...
	DATA_PARAM/*41*/, 0, 2, 1, TYPE_String, FN_pattern, TYPE_String, FN_option, TYPE_Regex, FN_return,
	...
	DATA_PARAM/*46*/, 0, 2, 1, TYPE_Object, FN_value, TYPE_Method, FN_mtd, TYPE_This, FN_return,
	DATA_PARAM/*47*/, 0, 3, 1, TYPE_Int, FN_init, TYPE_String, FN_path, TYPE_NameSpace, FN_ns, TYPE_This, FN_return,
	DATA_PARAM/*48*/, 0, 2, 1, TYPE_String, FN_event, TYPE_String, FN_msg, TYPE_Exception, FN_return,
	DATA_PARAM/*49*/, 0, 2, 1, TYPE_dynamic, FN_base, TYPE_Method, FN_method, TYPE_This, FN_return,
	DATA_PARAM/*50*/, 0, 1, 1, TYPE_String, FN_msg, TYPE_Assurance, FN_return,
	DATA_PARAM/*51*/, 0, 1, 1, TYPE_Class, FN_c, TYPE_Boolean, FN_return,
	DATA_PARAM/*52*/, 0, 1, 1, TYPE_dynamic, FN_value, TYPE_Boolean, FN_return,
	DATA_PARAM/*53*/, 0, 1, 1, TYPE_Int, FN_value, TYPE_Boolean, FN_return,
	DATA_PARAM/*54*/, 0, 1, 1, TYPE_Float, FN_value, TYPE_Boolean, FN_return,
	DATA_PARAM/*55*/, 0, 1, 1, TYPE_String, FN_s, TYPE_Boolean, FN_return,
	DATA_PARAM/*56*/, 0, 1, 1, TYPE_dynamic, FN_v, TYPE_Boolean, FN_return,
	DATA_PARAM/*57*/, 0, 1, 1, TYPE_Int, FN_v, TYPE_Int, FN_return,
	DATA_PARAM/*58*/, 0, 1, 1, TYPE_Float, FN_v, TYPE_Float, FN_return,
	DATA_PARAM/*59*/, 0, 1, 1, TYPE_Float, FN_n, TYPE_Float, FN_return,
	DATA_PARAM/*60*/, 0, 1, 1, TYPE_String, FN_s, TYPE_String, FN_return,
	...
	DATA_PARAM/*64*/, 0, 1, 1, TYPE_Int, FN_n, TYPE_String, FN_return,
	DATA_PARAM/*65*/, 0, 2, 1, TYPE_Int, FN_s, TYPE_Int, FN_e, TYPE_Bytes, FN_return,
	DATA_PARAM/*66*/, 0, 2, 1, TYPE_Int, FN_offset, TYPE_Int, FN_length, TYPE_String, FN_return,
	DATA_PARAM/*67*/, 0, 2, 1, TYPE_Int, FN_s, TYPE_Int, FN_e, TYPE_String, FN_return,
	DATA_PARAM/*68*/, 0, 2, 1, TYPE_Int, FN_s, TYPE_Int, FN_e, TYPE_This, FN_return,
	DATA_PARAM/*69*/, 0, 2, 1, TYPE_String, FN_urn, TYPE_NameSpace, FN_ns, TYPE_This, FN_return,
	DATA_PARAM/*70*/, 0, 1, 1, TYPE_String, FN_query, TYPE_ResultSet, FN_return,
	DATA_PARAM/*71*/, 0, 1, 0, TYPE_String, FN_query,
	DATA_PARAM/*72*/, 0, 1, 1, TYPE_dynamic, FN_n, TYPE_Int, FN_return,
	DATA_PARAM/*73*/, 0, 1, 1, TYPE_dynamic, FN_n, TYPE_Float, FN_return,
	DATA_PARAM/*74*/, 0, 1, 1, TYPE_dynamic, FN_n, TYPE_String, FN_return,
	DATA_PARAM/*75*/, 0, 1, 1, TYPE_dynamic, FN_n, TYPE_dynamic, FN_return,
	DATA_PARAM/*76*/, 0, 3, 1, TYPE_String, FN_urn, TYPE_String, FN_mode, TYPE_NameSpace, FN_, TYPE_InputStream, FN_return,
	DATA_PARAM/*77*/, 0, 1, 1, TYPE_StringDecoder, FN_c, TYPE_StringDecoder, FN_return,
	DATA_PARAM/*78*/, 0, 3, 1, TYPE_String, FN_urn, TYPE_String, FN_mode, TYPE_NameSpace, FN_, TYPE_OutputStream, FN_return,
	...
	DATA_PARAM/*82*/, FLAG_ParamArray_VARGs, 1, 0, TYPE_dynamic, FN_value,
	...
	DATA_PARAM/*86*/, 0, 1, 1, TYPE_String, FN_fmt, TYPE_String, FN_return,
	DATA_PARAM/*87*/, 0, 3, 1, TYPE_String, FN_fi, TYPE_NameSpace, FN_ns, TYPE_Class, FN_c, TYPE_dynamic, FN_return,
	DATA_PARAM/*88*/, 0, 1, 1, TYPE_NameSpace, FN_ns, TYPE_Boolean, FN_return,
	...
	DATA_PARAM/*95*/, 0, 2, 1, TYPE_Regex, FN_re, TYPE_NameSpace, FN_ns, TYPE_Map, FN_return,
	DATA_PARAM/*96*/, 0, 1, 1, TYPE_Converter, FN_enc, TYPE_Bytes, FN_return,
	DATA_PARAM/*97*/, 0, 1, 1, TYPE_StringEncoder, FN_enc, TYPE_Bytes, FN_return,
	DATA_PARAM/*98*/, 0, 1, 1, TYPE_StringDecoder, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*99*/, 0, 1, 1, TYPE_StringConverter, FN_c, TYPE_String, FN_return,
	DATA_PARAM/*100*/, 0, 0, 1, TYPE_StringITR, FN_return,
...
static knh_data_t APIData0[] = {
	...
	DATA_METHOD0, CLASS_Func, MN_invoke, FLAG_Method_Hidden|FLAG_Method_Private, _DATA(Func_invoke), /*P=*/29,
	...
	DATA_METHOD0, CLASS_Map, MN_opHAS, 0, _DATA(Map_opHAS), /*P=*/30,
	DATA_METHOD0, CLASS_Map, MN_get, 0, _DATA(Map_get), /*P=*/31,
	DATA_METHOD0, CLASS_Map, MN_set, 0, _DATA(DictMap_set), /*P=*/32,
	DATA_METHOD0, CLASS_Map, MN_remove, 0, _DATA(DictMap_remove), /*P=*/33,
	DATA_METHOD0, CLASS_Map, MN_keys, 0, _DATA(Map_keys), /*P=*/34,
	DATA_METHOD0, CLASS_Map, MN_opITR, 0, _DATA(Map_T1__), /*P=*/19,
	DATA_METHOD0, CLASS_System, MN_setRandomSeed, FLAG_Method_Static, _DATA(System_setRandomSeed), /*P=*/35,
	DATA_METHOD0, CLASS_Int, MN_random, FLAG_Method_Static, _DATA(Int_random), /*P=*/36,
	DATA_METHOD0, CLASS_Float, MN_random, FLAG_Method_Static, _DATA(Float_random), /*P=*/37,
	...
	DATA_METHOD0, CLASS_Iterator, MN_new, FLAG_Method_Hidden, _DATA(Iterator_new), /*P=*/46,
	DATA_METHOD0, CLASS_Map, MN_new, 0, _DATA(Map_new), /*P=*/47,
	DATA_METHOD0, CLASS_Map, MN_new__MAP, FLAG_Method_Hidden, _DATA(Map_newMAP), /*P=*/45,
	DATA_METHOD0, CLASS_Exception, MN_new, 0, _DATA(Exception_new), /*P=*/48,
	DATA_METHOD0, CLASS_Func, MN_new, 0, _DATA(Func_new), /*P=*/49,
	DATA_METHOD0, CLASS_Assurance, MN_new, FLAG_Method_Const, _DATA(Assurance_new), /*P=*/50,
	DATA_METHOD0, CLASS_Object, MN_opADDR, FLAG_Method_Const, _DATA(Object_opADDR), /*P=*/23,
	DATA_METHOD0, CLASS_Object, MN_opOF, FLAG_Method_Const, _DATA(Object_opOF), /*P=*/51,
	DATA_METHOD0, CLASS_Object, MN_opEQ, FLAG_Method_Const, _DATA(Object_opEQ), /*P=*/52,
	DATA_METHOD0, CLASS_Object, MN_opNOTEQ, FLAG_Method_Const, _DATA(Object_opNOTEQ), /*P=*/52,
	DATA_METHOD0, CLASS_Object, MN_opLT, FLAG_Method_Const, _DATA(Object_opLT), /*P=*/52,
	DATA_METHOD0, CLASS_Object, MN_opLTE, FLAG_Method_Const, _DATA(Object_opLTE), /*P=*/52,
	DATA_METHOD0, CLASS_Object, MN_opGT, FLAG_Method_Const, _DATA(Object_opGT), /*P=*/52,
	DATA_METHOD0, CLASS_Object, MN_opGTE, FLAG_Method_Const, _DATA(Object_opGTE), /*P=*/52,
	DATA_METHOD0, CLASS_Int, MN_opEQ, FLAG_Method_Const, _DATA(Int_opEQ), /*P=*/53,
	DATA_METHOD0, CLASS_Int, MN_opNOTEQ, FLAG_Method_Const, _DATA(Int_opNOTEQ), /*P=*/53,
	DATA_METHOD0, CLASS_Int, MN_opLT, FLAG_Method_Const, _DATA(Int_opLT), /*P=*/53,
	DATA_METHOD0, CLASS_Int, MN_opLTE, FLAG_Method_Const, _DATA(Int_opLTE), /*P=*/53,
	DATA_METHOD0, CLASS_Int, MN_opGT, FLAG_Method_Const, _DATA(Int_opGT), /*P=*/53,
	DATA_METHOD0, CLASS_Int, MN_opGTE, FLAG_Method_Const, _DATA(Int_opGTE), /*P=*/53,
	DATA_METHOD0, CLASS_Float, MN_opEQ, FLAG_Method_Const, _DATA(Float_opEQ), /*P=*/54,
	DATA_METHOD0, CLASS_Float, MN_opNOTEQ, FLAG_Method_Const, _DATA(Float_opNOTEQ), /*P=*/54,
	DATA_METHOD0, CLASS_Float, MN_opLT, FLAG_Method_Const, _DATA(Float_opLT), /*P=*/54,
	DATA_METHOD0, CLASS_Float, MN_opLTE, FLAG_Method_Const, _DATA(Float_opLTE), /*P=*/54,
	DATA_METHOD0, CLASS_Float, MN_opGT, FLAG_Method_Const, _DATA(Float_opGT), /*P=*/54,
	DATA_METHOD0, CLASS_Float, MN_opGTE, FLAG_Method_Const, _DATA(Float_opGTE), /*P=*/54,
	DATA_METHOD0, CLASS_String, MN_opHAS, FLAG_Method_Const, _DATA(String_opHAS), /*P=*/55,
	DATA_METHOD0, CLASS_Array, MN_opHAS, 0, _DATA(Array_opHAS), /*P=*/56,
	DATA_METHOD0, CLASS_Object, MN_opIS, FLAG_Method_Const, _DATA(Object_opIS), /*P=*/56,
	DATA_METHOD0, CLASS_Int, MN_opADD, FLAG_Method_Const, _DATA(Int_opADD), /*P=*/57,
	DATA_METHOD0, CLASS_Int, MN_opNEG, FLAG_Method_Const, _DATA(Int_opNEG), /*P=*/23,
	DATA_METHOD0, CLASS_Int, MN_opSUB, FLAG_Method_Const, _DATA(Int_opSUB), /*P=*/36,
	DATA_METHOD0, CLASS_Int, MN_opMUL, FLAG_Method_Const, _DATA(Int_opMUL), /*P=*/36,
	DATA_METHOD0, CLASS_Int, MN_opDIV, FLAG_Method_Const, _DATA(Int_opDIV), /*P=*/36,
	DATA_METHOD0, CLASS_Int, MN_opMOD, FLAG_Method_Const, _DATA(Int_opMOD), /*P=*/36,
	DATA_METHOD0, CLASS_Float, MN_opADD, FLAG_Method_Const, _DATA(Float_opADD), /*P=*/58,
	DATA_METHOD0, CLASS_Float, MN_opNEG, FLAG_Method_Const, _DATA(Float_opNEG), /*P=*/37,
	DATA_METHOD0, CLASS_Float, MN_opSUB, FLAG_Method_Const, _DATA(Float_opSUB), /*P=*/59,
	DATA_METHOD0, CLASS_Float, MN_opMUL, FLAG_Method_Const, _DATA(Float_opMUL), /*P=*/59,
	DATA_METHOD0, CLASS_Float, MN_opDIV, FLAG_Method_Const, _DATA(Float_opDIV), /*P=*/59,
	DATA_METHOD0, CLASS_String, MN_opSUB, FLAG_Method_Const, _DATA(String_opSUB), /*P=*/60,
	...
	DATA_METHOD0, CLASS_Int, MN_opLXOR, FLAG_Method_Const, _DATA(Int_opLXOR), /*P=*/36,
	DATA_METHOD0, CLASS_Int, MN_opLNOT, FLAG_Method_Const, _DATA(Int_opLNOT), /*P=*/23,
	DATA_METHOD0, CLASS_Int, MN_opLSFT, FLAG_Method_Const, _DATA(Int_opLSFT), /*P=*/36,
	DATA_METHOD0, CLASS_Int, MN_opRSFT, FLAG_Method_Const, _DATA(Int_opRSFT), /*P=*/36,
	...
	DATA_METHOD0, CLASS_Bytes, MN_get, 0, _DATA(Bytes_get), /*P=*/36,
	DATA_METHOD0, CLASS_Bytes, MN_set, 0, _DATA(Bytes_set), /*P=*/62,
	DATA_METHOD0, CLASS_Bytes, MN_setAll, 0, _DATA(Bytes_setAll), /*P=*/63,
	DATA_METHOD0, CLASS_String, MN_get, FLAG_Method_Const, _DATA(String_get), /*P=*/64,
	DATA_METHOD0, CLASS_Bytes, MN_opUNTIL, 0, _DATA(Bytes_opUNTIL), /*P=*/65,
	DATA_METHOD0, CLASS_Bytes, MN_opTO, 0, _DATA(Bytes_opTO), /*P=*/65,
	DATA_METHOD0, CLASS_String, MN_substring, FLAG_Method_Const, _DATA(String_substring), /*P=*/66,
	DATA_METHOD0, CLASS_String, MN_opUNTIL, FLAG_Method_Const, _DATA(String_opUNTIL), /*P=*/67,
	DATA_METHOD0, CLASS_String, MN_opTO, FLAG_Method_Const, _DATA(String_opTO), /*P=*/67,
	DATA_METHOD0, CLASS_Array, MN_opUNTIL, 0, _DATA(Array_opUNTIL), /*P=*/68,
	DATA_METHOD0, CLASS_Array, MN_opTO, 0, _DATA(Array_opTO), /*P=*/68,
	DATA_METHOD0, CLASS_Connection, MN_new, 0, _DATA(Connection_new), /*P=*/69,
	DATA_METHOD0, CLASS_Connection, MN_query, 0, _DATA(Connection_query), /*P=*/70,
	DATA_METHOD0, CLASS_Connection, MN_exec, 0, _DATA(Connection_exec), /*P=*/71,
	...
	DATA_METHOD0, CLASS_ResultSet, MN_getName, 0, _DATA(ResultSet_getName), /*P=*/64,
	DATA_METHOD0, CLASS_ResultSet, MN_getInt, 0, _DATA(ResultSet_getInt), /*P=*/72,
	DATA_METHOD0, CLASS_ResultSet, MN_getFloat, 0, _DATA(ResultSet_getFloat), /*P=*/73,
	DATA_METHOD0, CLASS_ResultSet, MN_getString, 0, _DATA(ResultSet_getString), /*P=*/74,
	DATA_METHOD0, CLASS_ResultSet, MN_get, 0, _DATA(ResultSet_get), /*P=*/75,
	DATA_METHOD0, CLASS_ResultSet, MN_close, 0, _DATA(ResultSet_close), /*P=*/0,
	DATA_METHOD0, CLASS_InputStream, MN_new, FLAG_Method_Throwable, _DATA(InputStream_new), /*P=*/76,
	...
	DATA_METHOD0, CLASS_OutputStream, MN_new, FLAG_Method_Throwable, _DATA(OutputStream_new), /*P=*/78,
	DATA_METHOD0, CLASS_OutputStream, MN_writeASCII, 0, _DATA(OutputStream_writeASCII), /*P=*/79,
	...
	DATA_METHOD0, CLASS_OutputStream, MN_println, 0, _DATA(OutputStream_println), /*P=*/82,
	DATA_METHOD0, CLASS_OutputStream, MN_send, 0, _DATA(OutputStream_send), /*P=*/83,
	...
	DATA_METHOD0, CLASS_Int, MN_format, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Int_format), /*P=*/86,
	DATA_METHOD0, CLASS_Float, MN_format, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Float_format), /*P=*/86,
	DATA_METHOD0, CLASS_String, MN_format, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(String_format), /*P=*/86,
	...
	DATA_METHOD0, CLASS_Link, MN_newObject, FLAG_Method_Hidden|FLAG_Method_Private, _DATA(Link_newObject), /*P=*/87,
	DATA_METHOD0, CLASS_String, MN_opEXISTS, FLAG_Method_Hidden, _DATA(String_opEXISTS), /*P=*/88,
	DATA_METHOD0, CLASS_String, MN_equals, FLAG_Method_Const, _DATA(String_equals), /*P=*/55,
	DATA_METHOD0, CLASS_String, MN_startsWith, FLAG_Method_Const, _DATA(String_startsWith), /*P=*/55,
	DATA_METHOD0, CLASS_String, MN_endsWith, FLAG_Method_Const, _DATA(String_endsWith), /*P=*/55,
	...
	DATA_METHOD0, CLASS_String, MN_extract, FLAG_Method_Const, _DATA(String_extract), /*P=*/95,
	DATA_METHOD0, CLASS_Bytes, MN_, FLAG_Method_Const, _DATA(Bytes_convert), /*P=*/96,
	DATA_METHOD0, CLASS_String, MN_encode, FLAG_Method_Const, _DATA(String_encode), /*P=*/97,
	DATA_METHOD0, CLASS_Bytes, MN_decode, FLAG_Method_Const, _DATA(Bytes_toString), /*P=*/98,
	DATA_METHOD0, CLASS_String, MN_, FLAG_Method_Const, _DATA(String_convert), /*P=*/99,
	DATA_METHOD0, CLASS_String, MN_convert, FLAG_Method_Const, _DATA(String_convert), /*P=*/99,
	DATA_METHOD0, CLASS_String, MN_trim, FLAG_Method_Const, _DATA(String_trim), /*P=*/25,
	DATA_METHOD0, CLASS_Regex, MN_opHAS, FLAG_Method_Const, _DATA(Regex_opHAS), /*P=*/55,
	DATA_METHOD0, CLASS_String, MN_opITR, 0, _DATA(String_Iterator), /*P=*/100,
