...
static knh_data_t ParamArrayData0[] = {
	...
	DATA_PARAM/*25*/, 0, 1, 1, TYPE_Class, FN_auto, TYPE_dynamic, FN_return,
	...
	DATA_PARAM/*105*/, 0, 1, 1, TYPE_InputStream, FN_in, TYPE_InputStream, FN_return,
	DATA_PARAM/*106*/, 0, 1, 1, TYPE_OutputStream, FN_out, TYPE_OutputStream, FN_return,
	DATA_PARAM/*107*/, 0, 1, 1, TYPE_String, FN_event, TYPE_Boolean, FN_return,
	DATA_PARAM/*108*/, 0, 2, 1, TYPE_String, FN_name, TYPE_Object, FN_value, TYPE_dynamic, FN_return,
	DATA_PARAM/*109*/, 0, 2, 1, TYPE_String, FN_cmd, TYPE_Class, FN_reqt, TYPE_String, FN_return,
...
static knh_data_t APIData0[] = {
	...
	DATA_METHOD0, CLASS_Object, MN_typeCheck, FLAG_Method_Const|FLAG_Method_Hidden|FLAG_Method_Private, _DATA(Object_typeCheck), /*P=*/25,
	...
	DATA_METHOD0, CLASS_Context, MN_setIn, FLAG_Method_Static, _DATA(CTX_setIn), /*P=*/105,
	DATA_METHOD0, CLASS_Context, MN_setOut, FLAG_Method_Static, _DATA(CTX_setOut), /*P=*/106,
	DATA_METHOD0, CLASS_Context, MN_setErr, FLAG_Method_Static, _DATA(CTX_setErr), /*P=*/106,
	DATA_METHOD0, CLASS_Exception, MN_opOF, 0, _DATA(Exception_opOF), /*P=*/107,
	DATA_METHOD0, CLASS_Class, MN_setConst, FLAG_Method_Const|FLAG_Method_Hidden, _DATA(Class_setConst), /*P=*/108,
