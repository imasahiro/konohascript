...
/* MACROS */
#ifndef K_REVISION
#define K_REVISION                      605
#endif
#define K_BUILDID                       1168
...
#define FN_startswith   (MN_OPSIZE+116)
#define FN_status       (MN_OPSIZE+117)
...
#define FN_xdata        (MN_OPSIZE+135)
#define FN_y            (MN_OPSIZE+136)
#define FN_year         (MN_OPSIZE+137)
