...
/* MACROS */
#ifndef K_REVISION
#define K_REVISION                      206
#endif
#define K_BUILDID                       1102
...
#define FN_keys         (MN_OPSIZE+63)
#define FN_lastIndexOf  (MN_OPSIZE+64)
#define FN_lastindexof  (MN_OPSIZE+64)
#define FN_length       (MN_OPSIZE+65)
#define FN_listProperties (MN_OPSIZE+66)
#define FN_listproperties (MN_OPSIZE+66)
#define FN_m            (MN_OPSIZE+67)
#define FN_main         (MN_OPSIZE+68)
#define FN_match        (MN_OPSIZE+69)
#define FN_method       (MN_OPSIZE+70)
#define FN_mode         (MN_OPSIZE+71)
#define FN_mon          (MN_OPSIZE+72)
...
#define FN_new__tuple   (MN_OPSIZE+80)
#define FN_next         (MN_OPSIZE+81)
#define FN_notNull      (MN_OPSIZE+82)
#define FN_notnull      (MN_OPSIZE+82)
#define FN_ns           (MN_OPSIZE+83)
#define FN_null         (MN_OPSIZE+84)
#define FN_offset       (MN_OPSIZE+85)
...
#define FN_writedata    (MN_OPSIZE+134)
#define FN_writeObject  (MN_OPSIZE+135)
#define FN_writeobject  (MN_OPSIZE+135)
