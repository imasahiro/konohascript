...
/* MACROS */
#ifndef K_REVISION
#define K_REVISION                      496
#endif
#define K_BUILDID                       1156
...
#define FN_min          (MN_OPSIZE+73)
#define FN_mode         (MN_OPSIZE+74)
#define FN_month        (MN_OPSIZE+75)
#define FN_msg          (MN_OPSIZE+76)
#define FN_mtd          (MN_OPSIZE+77)
#define FN_n            (MN_OPSIZE+78)
#define FN_name         (MN_OPSIZE+79)
#define FN_new          (MN_OPSIZE+80)
#define FN_new__ARRAY   (MN_OPSIZE+81)
#define FN_new__array   (MN_OPSIZE+81)
#define FN_new__LIST    (MN_OPSIZE+82)
#define FN_new__list    (MN_OPSIZE+82)
#define FN_new__MAP     (MN_OPSIZE+83)
#define FN_new__map     (MN_OPSIZE+83)
#define FN_new__TUPLE   (MN_OPSIZE+84)
#define FN_new__tuple   (MN_OPSIZE+84)
...
#define FN_startswith   (MN_OPSIZE+118)
#define FN_status       (MN_OPSIZE+119)
