...
#define FN_cc           (MN_OPSIZE+15)
#define FN_ch           (MN_OPSIZE+16)
#define FN_char         (MN_OPSIZE+17)
#define FN_charset      (MN_OPSIZE+18)
#define FN_class        (MN_OPSIZE+19)
#define FN_clear        (MN_OPSIZE+20)
#define FN_close        (MN_OPSIZE+21)
#define FN_closed       (MN_OPSIZE+22)
#define FN_cmd          (MN_OPSIZE+23)
