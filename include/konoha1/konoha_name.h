...
#define FN_eval         (MN_OPSIZE+41)
#define FN_event        (MN_OPSIZE+42)
#define FN_exec         (MN_OPSIZE+43)
...
#define FN_typeCheck    (MN_OPSIZE+128)
#define FN_typecheck    (MN_OPSIZE+128)
#define FN_u            (MN_OPSIZE+129)
#define FN_urn          (MN_OPSIZE+130)
#define FN_v            (MN_OPSIZE+131)
#define FN_value        (MN_OPSIZE+132)
#define FN_vargs        (MN_OPSIZE+133)
#define FN_w            (MN_OPSIZE+134)
#define FN_write        (MN_OPSIZE+135)
#define FN_writeASCII   (MN_OPSIZE+136)
#define FN_writeascii   (MN_OPSIZE+136)
#define FN_writeData    (MN_OPSIZE+137)
#define FN_writedata    (MN_OPSIZE+137)
#define FN_writeObject  (MN_OPSIZE+138)
#define FN_writeobject  (MN_OPSIZE+138)
