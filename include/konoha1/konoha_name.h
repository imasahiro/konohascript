...
/* MACROS */
#ifndef K_REVISION
#define K_REVISION                      457
#endif
#define K_BUILDID                       1148
...
/* ------------------------------------------------------------------------ */
/* Path */
#define CLASS_Path              ((knh_class_t)29)
...
#define FN_hashcode     (MN_OPSIZE+55)
#define FN_hour         (MN_OPSIZE+56)
#define FN_in           (MN_OPSIZE+57)
#define FN_indexOf      (MN_OPSIZE+58)
#define FN_indexof      (MN_OPSIZE+58)
#define FN_init         (MN_OPSIZE+59)
#define FN_initCapacity (MN_OPSIZE+60)
#define FN_initcapacity (MN_OPSIZE+60)
#define FN_insert       (MN_OPSIZE+61)
#define FN_int          (MN_OPSIZE+62)
...
#define FN_min          (MN_OPSIZE+74)
#define FN_mode         (MN_OPSIZE+75)
#define FN_month        (MN_OPSIZE+76)
#define FN_msg          (MN_OPSIZE+77)
#define FN_mtd          (MN_OPSIZE+78)
#define FN_n            (MN_OPSIZE+79)
#define FN_name         (MN_OPSIZE+80)
#define FN_new          (MN_OPSIZE+81)
#define FN_new__ARRAY   (MN_OPSIZE+82)
#define FN_new__array   (MN_OPSIZE+82)
#define FN_new__LIST    (MN_OPSIZE+83)
#define FN_new__list    (MN_OPSIZE+83)
#define FN_new__MAP     (MN_OPSIZE+84)
#define FN_new__map     (MN_OPSIZE+84)
#define FN_new__TUPLE   (MN_OPSIZE+85)
#define FN_new__tuple   (MN_OPSIZE+85)
#define FN_next         (MN_OPSIZE+86)
#define FN_notNull      (MN_OPSIZE+87)
#define FN_notnull      (MN_OPSIZE+87)
#define FN_ns           (MN_OPSIZE+88)
#define FN_null         (MN_OPSIZE+89)
#define FN_offset       (MN_OPSIZE+90)
#define FN_option       (MN_OPSIZE+91)
#define FN_out          (MN_OPSIZE+92)
#define FN_path         (MN_OPSIZE+93)
#define FN_pattern      (MN_OPSIZE+94)
#define FN_pop          (MN_OPSIZE+95)
#define FN_print        (MN_OPSIZE+96)
#define FN_println      (MN_OPSIZE+97)
#define FN_property     (MN_OPSIZE+98)
#define FN_putc         (MN_OPSIZE+99)
#define FN_query        (MN_OPSIZE+100)
#define FN_random       (MN_OPSIZE+101)
#define FN_randomSeed   (MN_OPSIZE+102)
#define FN_randomseed   (MN_OPSIZE+102)
#define FN_re           (MN_OPSIZE+103)
#define FN_readLine     (MN_OPSIZE+104)
#define FN_readline     (MN_OPSIZE+104)
#define FN_remove       (MN_OPSIZE+105)
#define FN_replace      (MN_OPSIZE+106)
#define FN_reset        (MN_OPSIZE+107)
#define FN_reverse      (MN_OPSIZE+108)
#define FN_s            (MN_OPSIZE+109)
#define FN_search       (MN_OPSIZE+110)
#define FN_sec          (MN_OPSIZE+111)
...
#define FN_startswith   (MN_OPSIZE+119)
#define FN_status       (MN_OPSIZE+120)
#define FN_string       (MN_OPSIZE+121)
#define FN_substring    (MN_OPSIZE+122)
