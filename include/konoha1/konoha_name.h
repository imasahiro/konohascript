...
#define CFLAG_Tvar_             ((knh_flag_t)0)
...
/* ------------------------------------------------------------------------ */
/* dynamic */
#define CLASS_dynamic           ((knh_class_t)9)
#define IS_dynamic(o)           (O_cid(o) == CLASS_dynamic)
#define IS_bdynamic(o)          (O_bcid(o) == CLASS_dynamic)
#define TYPE_dynamic            CLASS_dynamic
#define CFLAG_dynamic           ((knh_flag_t)0)
#define FLAG_dynamic            KNH_MAGICFLAG(CFLAG_dynamic)
...
/* ------------------------------------------------------------------------ */
/* Goal */
#define CLASS_Goal              ((knh_class_t)37)
#define IS_Goal(o)              (O_cid(o) == CLASS_Goal)
#define IS_bGoal(o)             (O_bcid(o) == CLASS_Goal)
#define TYPE_Goal               CLASS_Goal
#define CFLAG_Goal              ((knh_flag_t)0)
#define FLAG_Goal               KNH_MAGICFLAG(CFLAG_Goal)

/* ------------------------------------------------------------------------ */
/* UnitTest */
#define CLASS_UnitTest          ((knh_class_t)38)
...
#define CFLAG_UnitTest          ((knh_flag_t)0)
#define FLAG_UnitTest           KNH_MAGICFLAG(CFLAG_UnitTest)

/* ------------------------------------------------------------------------ */
/* Term */
#define CLASS_Term              ((knh_class_t)39)
...
/* ------------------------------------------------------------------------ */
/* Channel */
#define CLASS_Channel           ((knh_class_t)45)
#define IS_Channel(o)           (O_cid(o) == CLASS_Channel)
#define TYPE_Channel            CLASS_Channel

/* ------------------------------------------------------------------------ */
/* Cmpr */
#define CLASS_Cmpr              ((knh_class_t)46)
#define IS_Cmpr(o)              (O_cid(o) == CLASS_Cmpr)
#define TYPE_Cmpr               CLASS_Cmpr

/* ------------------------------------------------------------------------ */
/* StringITR */
#define CLASS_StringITR         ((knh_class_t)47)
...
#define Bytes_isStatic(o)  (TFLAG_is(knh_uintptr_t,(o)->h.magicflag,FLAG_Bytes_Static))
#define Bytes_setStatic(o,b) TFLAG_set(knh_uintptr_t,(o)->h.magicflag,FLAG_Bytes_Static,b)
...
#define InputStream_isFILE(o)  (TFLAG_is(knh_uintptr_t,(o)->h.magicflag,FLAG_InputStream_FILE))
#define InputStream_setFILE(o,b) TFLAG_set(knh_uintptr_t,(o)->h.magicflag,FLAG_InputStream_FILE,b)
...
#define OutputStream_isStoringBuffer(o)  (TFLAG_is(knh_uintptr_t,(o)->h.magicflag,FLAG_OutputStream_StoringBuffer))
#define OutputStream_setStoringBuffer(o,b) TFLAG_set(knh_uintptr_t,(o)->h.magicflag,FLAG_OutputStream_StoringBuffer,b)
...
#define FN_clearBuffer  (MN_OPSIZE+19)
#define FN_clearbuffer  (MN_OPSIZE+19)
...
#define FN_first        (MN_OPSIZE+45)
#define FN_flag         (MN_OPSIZE+46)
#define FN_float        (MN_OPSIZE+47)
#define FN_flush        (MN_OPSIZE+48)
#define FN_fmt          (MN_OPSIZE+49)
#define FN_format       (MN_OPSIZE+50)
#define FN_gc           (MN_OPSIZE+51)
#define FN_hashCode     (MN_OPSIZE+52)
#define FN_hashcode     (MN_OPSIZE+52)
...
#define FN_int          (MN_OPSIZE+58)
#define FN_invoke       (MN_OPSIZE+59)
#define FN_it           (MN_OPSIZE+60)
#define FN_k            (MN_OPSIZE+61)
#define FN_key          (MN_OPSIZE+62)
...
#define FN_writeChar    (MN_OPSIZE+131)
#define FN_writechar    (MN_OPSIZE+131)
...
#define MN_getSecond    MN_toGETTER(FN_second)
