...
#define FN_d            (MN_OPSIZE+25)
#define FN_data         (MN_OPSIZE+26)
#define FN_day          (MN_OPSIZE+27)
...
#define FN_min          (MN_OPSIZE+72)
#define FN_mode         (MN_OPSIZE+73)
#define FN_month        (MN_OPSIZE+74)
