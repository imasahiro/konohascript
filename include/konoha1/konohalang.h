...
#define STT_LET  ((knh_term_t)39)
#define STT_TCAST  ((knh_term_t)40)
#define STT_BOX  ((knh_term_t)41)
#define STT_OPR  ((knh_term_t)42)
#define STT_CALL  ((knh_term_t)43)
#define STT_NEW  ((knh_term_t)44)
#define STT_FUNCCALL  ((knh_term_t)45)
#define STT_ACALL  ((knh_term_t)46)
...
#define TT_CLASS   ((knh_term_t)64)
#define TT_FORMAT   ((knh_term_t)65)
#define TT_RETURN   ((knh_term_t)66)
#define TT_YIELD   ((knh_term_t)67)
#define TT_IF   ((knh_term_t)68)
#define TT_SWITCH   ((knh_term_t)69)
#define TT_CASE   ((knh_term_t)70)
#define TT_WHILE   ((knh_term_t)71)
#define TT_DO   ((knh_term_t)72)
#define TT_FOR   ((knh_term_t)73)
#define TT_FOREACH   ((knh_term_t)74)
#define TT_BREAK   ((knh_term_t)75)
#define TT_CONTINUE   ((knh_term_t)76)
#define TT_GOTO   ((knh_term_t)77)
#define TT_TRY   ((knh_term_t)78)
#define TT_CATCH   ((knh_term_t)79)
#define TT_THROW   ((knh_term_t)80)
#define TT_PRINT   ((knh_term_t)81)
#define TT_ASSURE   ((knh_term_t)82)
#define TT_ASSERT   ((knh_term_t)83)
#define TT_REGISTER   ((knh_term_t)84)
#define TT_GO   ((knh_term_t)85)
#define TT_EXTENDS   ((knh_term_t)86)
#define TT_IMPLEMENTS   ((knh_term_t)87)
#define TT_ELSE   ((knh_term_t)88)
#define TT_DEFAULT   ((knh_term_t)89)
#define TT_FINALLY   ((knh_term_t)90)
#define TT_SEMICOLON   ((knh_term_t)91)
#define TT_COMMA   ((knh_term_t)92)
#define TT_DIAMOND   ((knh_term_t)93)
#define TT_ARROW   ((knh_term_t)94)
#define TT_DARROW   ((knh_term_t)95)
#define TT_TARROW   ((knh_term_t)96)
#define TT_TDARROW   ((knh_term_t)97)
#define TT_EXPT   ((knh_term_t)98)
#define TT_LSEND   ((knh_term_t)99)
#define TT_RSEND   ((knh_term_t)100)
#define TT_DOTS   ((knh_term_t)101)
#define TT_DMUL   ((knh_term_t)102)
#define TT_ASIS   ((knh_term_t)103)
#define TT_FUNCTION   ((knh_term_t)104)
#define TT_NEW   ((knh_term_t)105)
#define TT_NULL   ((knh_term_t)106)
#define TT_TYPEOF   ((knh_term_t)107)
...
#define TT_PARENTHESIS   ((knh_term_t)115)
#define TT_BRANCET   ((knh_term_t)116)
#define TT_DECLLET   ((knh_term_t)117)
#define TT_LSFTE   ((knh_term_t)118)
#define TT_RSFTE   ((knh_term_t)119)
#define TT_ADDE   ((knh_term_t)120)
#define TT_SUBE   ((knh_term_t)121)
#define TT_DIVE   ((knh_term_t)122)
#define TT_MODE   ((knh_term_t)123)
#define TT_MULE   ((knh_term_t)124)
#define TT_LANDE   ((knh_term_t)125)
#define TT_LORE   ((knh_term_t)126)
#define TT_ALTLET   ((knh_term_t)127)
#define TT_LET   ((knh_term_t)128)
#define TT_ALT   ((knh_term_t)129)
#define TT_QTN   ((knh_term_t)130)
#define TT_COLON   ((knh_term_t)131)
#define TT_DOT   ((knh_term_t)132)
#define TT_OR   ((knh_term_t)133)
#define TT_AND   ((knh_term_t)134)
#define TT_NOT   ((knh_term_t)135)
#define TT_EXISTS   ((knh_term_t)136)
#define TT_FROM   ((knh_term_t)137)
#define TT_TO   ((knh_term_t)138)
#define TT_AS   ((knh_term_t)139)
#define TT_UNTIL   ((knh_term_t)140)
#define TT_IS   ((knh_term_t)141)
#define TT_OF   ((knh_term_t)142)
#define TT_IN   ((knh_term_t)143)
...
#define TT_LOR   ((knh_term_t)150)
#define TT_XOR   ((knh_term_t)151)
#define TT_LAND   ((knh_term_t)152)
#define TT_ADD   ((knh_term_t)153)
#define TT_SUB   ((knh_term_t)154)
#define TT_DIV   ((knh_term_t)155)
#define TT_MOD   ((knh_term_t)156)
#define TT_MUL   ((knh_term_t)157)
#define TT_LSFT   ((knh_term_t)158)
#define TT_RSFT   ((knh_term_t)159)
#define TT_LNOT   ((knh_term_t)160)
#define TT_NEXT   ((knh_term_t)161)
#define TT_PREV   ((knh_term_t)162)
#define TT_ITR   ((knh_term_t)163)
#define TT_TAND   ((knh_term_t)164)
#define TT_TMUL   ((knh_term_t)165)
#define TT_TADD   ((knh_term_t)166)
#define TT_TSUB   ((knh_term_t)167)
#define TT_CODE   ((knh_term_t)168)
#define TT_DOCU   ((knh_term_t)169)
#define TT_NUM   ((knh_term_t)170)
#define TT_STR   ((knh_term_t)171)
#define TT_TSTR   ((knh_term_t)172)
#define TT_ESTR   ((knh_term_t)173)
#define TT_REGEX   ((knh_term_t)174)
#define TT_DOC   ((knh_term_t)175)
#define TT_METAN   ((knh_term_t)176)
#define TT_PROPN   ((knh_term_t)177)
#define TT_URN   ((knh_term_t)178)
#define TT_TLINK   ((knh_term_t)179)
#define TT_NAME   ((knh_term_t)180)
#define TT_UNAME   ((knh_term_t)181)
#define TT_FUNCNAME   ((knh_term_t)182)
#define TT_UFUNCNAME   ((knh_term_t)183)
#define TT_PTYPE   ((knh_term_t)184)
#define TT_CID   ((knh_term_t)185)
#define TT_MN   ((knh_term_t)186)
#define TT_FMT   ((knh_term_t)187)
#define TT_CONST   ((knh_term_t)188)
#define TT_SYSVAL   ((knh_term_t)189)
#define TT_LOCAL   ((knh_term_t)190)
#define TT_FUNCVAR   ((knh_term_t)191)
#define TT_XLOCAL   ((knh_term_t)192)
#define TT_FIELD   ((knh_term_t)193)
#define TT_SCRFIELD   ((knh_term_t)194)
#define TT_ERR   ((knh_term_t)195)
#define TT_EOT   ((knh_term_t)196)
#endif/*MN_OPSIZE*/
