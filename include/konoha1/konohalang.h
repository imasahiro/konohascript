...
#define TT_DYNAMIC   ((knh_term_t)109)
...
#define TT_LINK   ((knh_term_t)135)
#define TT_QUERY   ((knh_term_t)136)
...
#define TT_WITH   ((knh_term_t)149)
#define TT_MATCH   ((knh_term_t)150)
#define TT_AS   ((knh_term_t)151)
#define TT_WHERE   ((knh_term_t)152)
#define TT_EACH   ((knh_term_t)153)
#define TT_LOR   ((knh_term_t)154)
#define TT_XOR   ((knh_term_t)155)
#define TT_LAND   ((knh_term_t)156)
#define TT_ADD   ((knh_term_t)157)
#define TT_SUB   ((knh_term_t)158)
#define TT_DIV   ((knh_term_t)159)
#define TT_MOD   ((knh_term_t)160)
#define TT_MUL   ((knh_term_t)161)
#define TT_LSFT   ((knh_term_t)162)
#define TT_RSFT   ((knh_term_t)163)
#define TT_LNOT   ((knh_term_t)164)
#define TT_NEXT   ((knh_term_t)165)
#define TT_PREV   ((knh_term_t)166)
#define TT_ITR   ((knh_term_t)167)
#define TT_SEQ   ((knh_term_t)168)
#define TT_EXPT   ((knh_term_t)169)
#define TT_TAND   ((knh_term_t)170)
#define TT_TMUL   ((knh_term_t)171)
#define TT_TADD   ((knh_term_t)172)
#define TT_TSUB   ((knh_term_t)173)
#define TT_CODE   ((knh_term_t)174)
#define TT_DOCU   ((knh_term_t)175)
#define TT_NUM   ((knh_term_t)176)
#define TT_STR   ((knh_term_t)177)
#define TT_TSTR   ((knh_term_t)178)
#define TT_ESTR   ((knh_term_t)179)
#define TT_REGEX   ((knh_term_t)180)
#define TT_DOC   ((knh_term_t)181)
#define TT_METAN   ((knh_term_t)182)
#define TT_PROPN   ((knh_term_t)183)
#define TT_URN   ((knh_term_t)184)
#define TT_TLINK   ((knh_term_t)185)
#define TT_NAME   ((knh_term_t)186)
#define TT_UNAME   ((knh_term_t)187)
#define TT_FUNCNAME   ((knh_term_t)188)
#define TT_UFUNCNAME   ((knh_term_t)189)
#define TT_PTYPE   ((knh_term_t)190)
#define TT_CID   ((knh_term_t)191)
#define TT_MN   ((knh_term_t)192)
#define TT_FMT   ((knh_term_t)193)
#define TT_CONST   ((knh_term_t)194)
#define TT_SYSVAL   ((knh_term_t)195)
#define TT_FVAR   ((knh_term_t)196)
#define TT_LVAR   ((knh_term_t)197)
#define TT_FIELD   ((knh_term_t)198)
#define TT_LFIELD   ((knh_term_t)199)
#define TT_ERR   ((knh_term_t)200)
#define TT_EOT   ((knh_term_t)201)
#endif/*MN_OPSIZE*/
