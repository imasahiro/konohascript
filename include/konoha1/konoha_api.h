...
typedef struct knh_api2_t {
	...
	knh_RawPtr_t* (*new_RawPtrByReturnType)(CTX ctx, knh_sfp_t *sfp, void *rawptr);
...
#define new_RawPtrByReturnType   ctx->api2->new_RawPtrByReturnType
