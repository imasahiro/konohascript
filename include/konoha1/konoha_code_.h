...
#define OPCODE_NMOVx ((kopcode_t)22)
...
#define OPCODE_XNSET ((kopcode_t)23)
...
#define OPCODE_XNMOV ((kopcode_t)24)
...
#define OPCODE_XNMOVx ((kopcode_t)25)
...
#define OPCODE_iINC ((kopcode_t)26)
typedef struct klr_iINC_t {
	struct KCODE_HEAD head;
	kregN_t a;
} klr_iINC_t;

#define OPCODE_iDEC ((kopcode_t)27)
typedef struct klr_iDEC_t {
	struct KCODE_HEAD head;
	kregN_t a;
} klr_iDEC_t;

#define OPCODE_bNUL ((kopcode_t)28)
...
#define OPCODE_bNN ((kopcode_t)29)
...
#define OPCODE_bNOT ((kopcode_t)30)
...
#define OPCODE_iNEG ((kopcode_t)31)
...
#define OPCODE_fNEG ((kopcode_t)32)
...
#define OPCODE_iTR ((kopcode_t)33)
...
#define OPCODE_fTR ((kopcode_t)34)
...
#define OPCODE_iADD ((kopcode_t)35)
...
#define OPCODE_iSUB ((kopcode_t)36)
...
#define OPCODE_iMUL ((kopcode_t)37)
...
#define OPCODE_iDIV ((kopcode_t)38)
...
#define OPCODE_iMOD ((kopcode_t)39)
...
#define OPCODE_iEQ ((kopcode_t)40)
...
#define OPCODE_iNEQ ((kopcode_t)41)
...
#define OPCODE_iLT ((kopcode_t)42)
...
#define OPCODE_iLTE ((kopcode_t)43)
...
#define OPCODE_iGT ((kopcode_t)44)
...
#define OPCODE_iGTE ((kopcode_t)45)
...
#define OPCODE_iAND ((kopcode_t)46)
...
#define OPCODE_iOR ((kopcode_t)47)
...
#define OPCODE_iXOR ((kopcode_t)48)
...
#define OPCODE_iLSFT ((kopcode_t)49)
...
#define OPCODE_iRSFT ((kopcode_t)50)
...
#define OPCODE_iADDC ((kopcode_t)51)
...
#define OPCODE_iSUBC ((kopcode_t)52)
...
#define OPCODE_iMULC ((kopcode_t)53)
...
#define OPCODE_iDIVC ((kopcode_t)54)
...
#define OPCODE_iMODC ((kopcode_t)55)
...
#define OPCODE_iEQC ((kopcode_t)56)
...
#define OPCODE_iNEQC ((kopcode_t)57)
...
#define OPCODE_iLTC ((kopcode_t)58)
...
#define OPCODE_iLTEC ((kopcode_t)59)
...
#define OPCODE_iGTC ((kopcode_t)60)
...
#define OPCODE_iGTEC ((kopcode_t)61)
...
#define OPCODE_iANDC ((kopcode_t)62)
...
#define OPCODE_iORC ((kopcode_t)63)
...
#define OPCODE_iXORC ((kopcode_t)64)
...
#define OPCODE_iLSFTC ((kopcode_t)65)
...
#define OPCODE_iRSFTC ((kopcode_t)66)
...
#define OPCODE_fADD ((kopcode_t)67)
...
#define OPCODE_fSUB ((kopcode_t)68)
...
#define OPCODE_fMUL ((kopcode_t)69)
...
#define OPCODE_fDIV ((kopcode_t)70)
...
#define OPCODE_fEQ ((kopcode_t)71)
...
#define OPCODE_fNEQ ((kopcode_t)72)
...
#define OPCODE_fLT ((kopcode_t)73)
...
#define OPCODE_fLTE ((kopcode_t)74)
...
#define OPCODE_fGT ((kopcode_t)75)
...
#define OPCODE_fGTE ((kopcode_t)76)
...
#define OPCODE_fADDC ((kopcode_t)77)
...
#define OPCODE_fSUBC ((kopcode_t)78)
...
#define OPCODE_fMULC ((kopcode_t)79)
...
#define OPCODE_fDIVC ((kopcode_t)80)
...
#define OPCODE_fEQC ((kopcode_t)81)
...
#define OPCODE_fNEQC ((kopcode_t)82)
...
#define OPCODE_fLTC ((kopcode_t)83)
...
#define OPCODE_fLTEC ((kopcode_t)84)
...
#define OPCODE_fGTC ((kopcode_t)85)
...
#define OPCODE_fGTEC ((kopcode_t)86)
...
#define OPCODE_RCINC ((kopcode_t)87)
typedef struct klr_RCINC_t {
	struct KCODE_HEAD head;
	kregO_t a;
} klr_RCINC_t;

#define OPCODE_RCDEC ((kopcode_t)88)
typedef struct klr_RCDEC_t {
	struct KCODE_HEAD head;
	kregO_t a;
} klr_RCDEC_t;

#define OPCODE_OSET ((kopcode_t)89)
...
#define OPCODE_OMOV ((kopcode_t)90)
...
#define OPCODE_OOMOV ((kopcode_t)91)
...
#define OPCODE_ONMOV ((kopcode_t)92)
...
#define OPCODE_OSET2 ((kopcode_t)93)
...
#define OPCODE_OSET3 ((kopcode_t)94)
...
#define OPCODE_RCINCx ((kopcode_t)95)
typedef struct klr_RCINCx_t {
	struct KCODE_HEAD head;
	ksfx_t a;
} klr_RCINCx_t;

#define OPCODE_RCDECx ((kopcode_t)96)
typedef struct klr_RCDECx_t {
	struct KCODE_HEAD head;
	ksfx_t a;
} klr_RCDECx_t;

#define OPCODE_OMOVx ((kopcode_t)97)
...
#define OPCODE_XMOV ((kopcode_t)98)
...
#define OPCODE_XOSET ((kopcode_t)99)
...
#define OPCODE_XMOVx ((kopcode_t)100)
...
#define OPCODE_CHKSTACK ((kopcode_t)101)
typedef struct klr_CHKSTACK_t {
	struct KCODE_HEAD head;
	ksfpidx_t n;
} klr_CHKSTACK_t;

#define OPCODE_LDMTD ((kopcode_t)102)
...
#define OPCODE_CALL ((kopcode_t)103)
...
#define OPCODE_SCALL ((kopcode_t)104)
...
#define OPCODE_VCALL ((kopcode_t)105)
...
#define OPCODE_VCALL_ ((kopcode_t)106)
...
#define OPCODE_FASTCALL0 ((kopcode_t)107)
...
#define OPCODE_RET ((kopcode_t)108)
typedef struct klr_RET_t {
	struct KCODE_HEAD head;
} klr_RET_t;

#define OPCODE_TR ((kopcode_t)109)
...
#define OPCODE_SCAST ((kopcode_t)110)
...
#define OPCODE_TCAST ((kopcode_t)111)
...
#define OPCODE_ACAST ((kopcode_t)112)
...
#define OPCODE_iCAST ((kopcode_t)113)
...
#define OPCODE_fCAST ((kopcode_t)114)
...
#define OPCODE_SAFEPOINT ((kopcode_t)115)
typedef struct klr_SAFEPOINT_t {
	struct KCODE_HEAD head;
	ksfpidx_t espshift;
} klr_SAFEPOINT_t;

#define OPCODE_JMP ((kopcode_t)116)
typedef struct klr_JMP_t {
	struct KCODE_HEAD head;
	kopl_t  *jumppc;
} klr_JMP_t;

#define OPCODE_JMP_ ((kopcode_t)117)
typedef struct klr_JMP__t {
	struct KCODE_HEAD head;
	kopl_t  *jumppc;
} klr_JMP__t;

#define OPCODE_JMPF ((kopcode_t)118)
...
#define OPCODE_NEXT ((kopcode_t)119)
...
#define OPCODE_BGETIDX ((kopcode_t)120)
...
#define OPCODE_BSETIDX ((kopcode_t)121)
...
#define OPCODE_BGETIDXC ((kopcode_t)122)
...
#define OPCODE_BSETIDXC ((kopcode_t)123)
...
#define OPCODE_NGETIDX ((kopcode_t)124)
...
#define OPCODE_NSETIDX ((kopcode_t)125)
...
#define OPCODE_NGETIDXC ((kopcode_t)126)
...
#define OPCODE_NSETIDXC ((kopcode_t)127)
...
#define OPCODE_OGETIDX ((kopcode_t)128)
...
#define OPCODE_OSETIDX ((kopcode_t)129)
...
#define OPCODE_OGETIDXC ((kopcode_t)130)
...
#define OPCODE_OSETIDXC ((kopcode_t)131)
...
#define OPCODE_bJNUL ((kopcode_t)132)
...
#define OPCODE_bJNN ((kopcode_t)133)
...
#define OPCODE_bJNOT ((kopcode_t)134)
...
#define OPCODE_iJEQ ((kopcode_t)135)
...
#define OPCODE_iJNEQ ((kopcode_t)136)
...
#define OPCODE_iJLT ((kopcode_t)137)
...
#define OPCODE_iJLTE ((kopcode_t)138)
...
#define OPCODE_iJGT ((kopcode_t)139)
...
#define OPCODE_iJGTE ((kopcode_t)140)
...
#define OPCODE_iJEQC ((kopcode_t)141)
...
#define OPCODE_iJNEQC ((kopcode_t)142)
...
#define OPCODE_iJLTC ((kopcode_t)143)
...
#define OPCODE_iJLTEC ((kopcode_t)144)
...
#define OPCODE_iJGTC ((kopcode_t)145)
...
#define OPCODE_iJGTEC ((kopcode_t)146)
...
#define OPCODE_fJEQ ((kopcode_t)147)
...
#define OPCODE_fJNEQ ((kopcode_t)148)
...
#define OPCODE_fJLT ((kopcode_t)149)
...
#define OPCODE_fJLTE ((kopcode_t)150)
...
#define OPCODE_fJGT ((kopcode_t)151)
...
#define OPCODE_fJGTE ((kopcode_t)152)
...
#define OPCODE_fJEQC ((kopcode_t)153)
...
#define OPCODE_fJNEQC ((kopcode_t)154)
...
#define OPCODE_fJLTC ((kopcode_t)155)
...
#define OPCODE_fJLTEC ((kopcode_t)156)
...
#define OPCODE_fJGTC ((kopcode_t)157)
...
#define OPCODE_fJGTEC ((kopcode_t)158)
...
#define OPCODE_CHKIDX ((kopcode_t)159)
...
#define OPCODE_CHKIDXC ((kopcode_t)160)
...
#define OPCODE_NOP ((kopcode_t)161)
typedef struct klr_NOP_t {
	struct KCODE_HEAD head;
} klr_NOP_t;

#define OPCODE_MAX ((kopcode_t)162)
