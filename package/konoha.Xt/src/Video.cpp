...
QImage* IplImage_convertToQImage2(const IplImage * iplImage, double mini, double maxi)
{
...
DEFAPI(void) constVideo(CTX ctx, knh_class_t cid, const knh_PackageLoaderAPI_t *kapi)
{
	(void)ctx;
	(void)cid;
	(void)kapi;
