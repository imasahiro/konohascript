...
METHOD MPICommunicator_getRank(CTX ctx, knh_sfp_t *sfp _RIX)
{
...
METHOD MPICommunicator_getSize(CTX ctx, knh_sfp_t *sfp _RIX)
{
	knh_MPIComm_t *comm = (knh_MPIComm_t*)sfp[0].o;
...
METHOD MPICommunicator_getProcessorName(CTX ctx, knh_sfp_t *sfp _RIX)
{
	knh_MPIComm_t *comm = (knh_MPIComm_t*)sfp[0].o;
...
METHOD MPICommunicator_getWtime(CTX ctx, knh_sfp_t *sfp _RIX)
{
	knh_MPIComm_t *comm = (knh_MPIComm_t*)sfp[0].o;
...
METHOD MPICommunicator_barrier(CTX ctx, knh_sfp_t *sfp _RIX)
{
	knh_MPIComm_t *comm = (knh_MPIComm_t*)sfp[0].o;
